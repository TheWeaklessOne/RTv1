...
void			rt_init(t_rt *rt)
{
	...
	rt->objects[0] = sphere_create((t_vec3f){0, 1, 3}, 1, (t_vec3f){108, 224, 117});
	rt->objects[1] = sphere_create((t_vec3f){2, 0, 4}, 1, (t_vec3f){86, 221, 245});
	rt->objects[2] = sphere_create((t_vec3f){-2, 0, 4}, 1, (t_vec3f){227, 48, 155});
	rt->objects[3] = sphere_create((t_vec3f){2, 5001, 0}, 5000, (t_vec3f){255, 255, 0});
}
